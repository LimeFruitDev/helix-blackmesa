...
SWEP.VElements = {
	["penguin"] = { type = "Model", model = "models/roblox/festive_penguin.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0.5, -2.5, -0.12), angle = Angle(270, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	-- ["candy_cane"] = { type = "Model", model = "models/weapons/eminem/candy_cane/v_candy_cane.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0, -3, 0), angle = Angle(90, 270, 0), size = Vector(1.054, 1.054, 1.054), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["baton"] = { type = "Model", model = "models/weapons/eminem/candy_cane/w_candy_cane.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, -4, -3), angle = Angle(-4.601, -80, 190), size = Vector(1.054, 1.054, 1.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
